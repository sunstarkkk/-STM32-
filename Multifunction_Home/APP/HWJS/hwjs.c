...
u8 HW_DMZY(void)
{
										if(hw_jsm == 0x00FFA25D)//电源
                    {
                        return 1;
                    }
                    else if(hw_jsm == 0x00FF6897)//按键 0
                    {
                        return 2;
                    }
                    else if(hw_jsm == 0x00FF30CF)//按键 1
                    {
                        return 3;
                    }
                    else if(hw_jsm == 0x00FF629D)//mode
                    {
                        return 4;
                    }
										else if(hw_jsm == 0x00FF10EF){//按键 4
												return 5;
										}
										else if(hw_jsm == 0x00FF38C7){//按键 5
												return 6;
										}
										else if(hw_jsm == 0x00FF5AA5){//按键 6
												return 7;
										}
										else if(hw_jsm == 0x00FF7A85){//按键 3
												return 8;
										}
										return 0;
}
